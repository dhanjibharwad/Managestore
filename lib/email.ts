...
export async function sendCustomerInviteEmail(
  ...
  const mailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: `Invitation to Join ${companyName} - Complete Your Registration`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
          ...
          <p style="margin-bottom: 20px;">You have been invited to join <strong>${companyName}</strong> as a customer on our platform.</p>
          
          <p style="margin-bottom: 25px;">Click the button below to complete your registration and start accessing your customer portal:</p>
          ...
          <p style="margin-bottom: 15px;">Once registered, you'll be able to:</p>
          <ul style="margin-bottom: 25px; padding-left: 20px;">
            <li>View your orders and job status</li>
            <li>Track payments and invoices</li>
            <li>Communicate with the company</li>
            <li>Access your account information</li>
          </ul>
          
          <p style="margin-bottom: 20px;">If you have any questions or need assistance, please contact ${companyName} directly.</p>
