...
//   return (
//     <Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-zinc-50 to-gray-100 flex items-center justify-center"><div className="text-gray-600">Loading...</div></div>}>
//       <VerifyEmailContent />
//     </Suspense>
//   );
// }
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-lg text-white/80">
            We've sent a verification code to your email address<br />for security purposes.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            ...
            <button
              ...
              onClick={handleResend}
              disabled={resendLoading || resendCooldown > 0}
              className="text-[#4A70A9] font-medium hover:text-[#3d5d8f] disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              {resendLoading ? (
                'Sending...'
              ) : resendCooldown > 0 ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              Wrong email?{' '}
              <Link href="/auth/register" className="text-[#4A70A9] font-medium hover:text-[#3d5d8f]">
                Go back
              </Link>
            </p>
          </div>
