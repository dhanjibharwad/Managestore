...
export default function UserHomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ScrollAnimatedSection className="py-8 sm:py-12 lg:py-16 bg-white" delay={100}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
          ...
          <div className="text-left lg:pl-8 order-1 lg:order-2">
            <p className="text-blue-500 text-xs sm:text-sm font-semibold mb-2 sm:mb-3 uppercase tracking-wide">
              About Us
            </p>
            <h2 className="mt-2 text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-wide drop-shadow-md font-serif text-gray-700">
      ...
      <ScrollAnimatedSection className="py-8 sm:py-12 lg:py-16 bg-white" delay={200}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
          {/* Left Image */}
