...
const DeviceTypesPage = ({ addModal = false, setAddModal }: DeviceTypesPageProps = {}) => {
  ...
  const [editModal, setEditModal] = useState<{show: boolean, type: DeviceType | null}>({show: false, type: null});
  ...
  return (
    <>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-full max-w-md p-6">
            <h3 className="text-lg font-semibold mb-4">Add Device Type</h3>
            <input type="text" value={formName} onChange={(e) => setFormName(e.target.value)} placeholder="Device Type Name" className="w-full px-3 py-2 border border-gray-300 rounded-md mb-4" />
      ...
      {editModal.show && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-full max-w-md p-6">
            <h3 className="text-lg font-semibold mb-4">Edit Device Type</h3>
