              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">{viewModal.request.region_state || 'Not Provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">City/Town</p>
                    <p className="text-sm font-medium text-gray-900">{viewModal.request.city_town || 'Not Provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Postal Code</p>
                    <p className="text-sm font-medium text-gray-900">{viewModal.request.postal_code || 'Not Provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Pickup Date/Time</p>
                    <p className="text-sm font-medium text-gray-900">{viewModal.request.pickup_datetime ? formatDateTime(viewModal.request.pickup_datetime) : 'Not Scheduled'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="mb-4">
                    ...
                    <p className="text-sm font-medium text-gray-900">{viewModal.request.services || 'Not Specified'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Detailed Issue</p>
                    <p className="text-sm font-medium text-gray-900 whitespace-pre-wrap">{viewModal.request.device_issue || 'No issue details provided'}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setViewJobModal({show: false, job: null})} className="text-gray-400 hover:text-gray-600">
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-blue-600">Job Information</h4>
                </div>
                <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Job Number</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.job_number}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Status</p>
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                      viewJobModal.job.status === 'Pending' ? 'bg-yellow-100 text-yellow-800' :
                      viewJobModal.job.status === 'In Progress' ? 'bg-blue-100 text-blue-800' :
                      viewJobModal.job.status === 'Completed' ? 'bg-green-100 text-green-800' :
                      viewJobModal.job.status === 'Cancelled' ? 'bg-red-100 text-red-800' :
                      'bg-gray-100 text-gray-800'
                    }`}>
                  ...
                  <div>
                    ...
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                      viewJobModal.job.priority === 'High' ? 'bg-red-100 text-red-800' :
                      viewJobModal.job.priority === 'Urgent' ? 'bg-orange-100 text-orange-800' :
                      viewJobModal.job.priority === 'Low' ? 'bg-gray-100 text-gray-800' :
                      'bg-blue-100 text-blue-800'
                    }`}>
                      {viewJobModal.job.priority}
                    </span>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Source</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.source || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Referred By</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.referred_by || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Service Type</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.service_type || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Job Type</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.job_type || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Created On</p>
                    <p className="text-sm font-medium text-gray-900">{formatDateTime(viewJobModal.job.created_at)}</p>
                  </div>
                  <div>
                  ...
                  {viewJobModal.job.dealer_job_id && (
                    <div className="col-span-2">
                      <p className="text-sm text-gray-600 mb-1">Dealer Job ID</p>
                      <p className="text-sm font-medium text-gray-900">{viewJobModal.job.dealer_job_id}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.customer_name}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Type</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.device_type_name || viewJobModal.job.device_type}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Brand</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.device_brand_name || viewJobModal.job.device_brand}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Model</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.device_model_name || viewJobModal.job.device_model || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Serial Number</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.serial_number || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Color</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.device_color || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Device Password</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.device_password || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Storage Location</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.storage_location || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Accessories</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.accessories || 'None'}</p>
                  </div>
                  {viewJobModal.job.hardware_config && (
                    <div className="col-span-2">
                      <p className="text-sm text-gray-600 mb-1">Hardware Configuration</p>
                      <p className="text-sm font-medium text-gray-900">{viewJobModal.job.hardware_config}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.services}</p>
                  </div>
                  {viewJobModal.job.service_assessment && (
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Service Assessment</p>
                      <p className="text-sm font-medium text-gray-900">{viewJobModal.job.service_assessment}</p>
                    </div>
                  )}
                  {viewJobModal.job.tags && (
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Tags</p>
                      <p className="text-sm font-medium text-gray-900">{viewJobModal.job.tags}</p>
                    </div>
                  )}
                  {viewJobModal.job.initial_quotation && (
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Initial Quotation</p>
                      <p className="text-sm font-medium text-gray-900">{viewJobModal.job.initial_quotation}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-blue-600">Assignment</h4>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Assigned To</p>
                    <p className="text-sm font-medium text-gray-900">{viewJobModal.job.assignee}</p>
                  </div>
                </div>
              </div>

              {/* Terms & Conditions */}
              {viewJobModal.job.terms_conditions && (
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-4">
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <h4 className="text-lg font-semibold text-blue-600">Terms & Conditions</h4>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-900 whitespace-pre-wrap">{viewJobModal.job.terms_conditions}</p>
                  </div>
                </div>
              )}

              {/* Device Images */}
              {viewJobModal.job.images && viewJobModal.job.images.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {viewJobModal.job.images.map((image: string, idx: number) => (
                      <div 
                        key={idx} 
                        className="relative aspect-square rounded-lg overflow-hidden border-2 border-gray-200 hover:border-blue-500 transition-all cursor-pointer group"
