    ...
    for (let i = firstDay - 1; i >= 0; i--) {
      days.push(
        <button
          key={`prev-${i}`}
          type="button"
          className="p-2 text-gray-400 text-sm hover:bg-gray-100 rounded"
          onClick={() => {
            changeMonth(-1);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                {showDatePicker && (
                  <div className="absolute top-full left-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-xl z-50 p-4 w-[350px]">
                    {/* Calendar Header */}
                    ...
                    <div className="flex items-center justify-center gap-2 mb-4 pb-4 border-b border-gray-200">
                      <select
                        ...
                        className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-[#4A70A9] focus:border-transparent outline-none"
                      >
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 px-4 py-2 text-sm bg-[#4A70A9] text-white rounded-md hover:bg-[#3d5c8f] transition-colors"
                      >
                        OK
                      </button>
                      <button
