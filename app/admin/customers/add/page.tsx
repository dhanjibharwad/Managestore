            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className={`flex-1 px-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-[#4A70A9] ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-[#4A70A9] ${
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded appearance-none bg-white focus:outline-none focus:ring-1 focus:ring-[#4A70A9] disabled:bg-gray-100 disabled:cursor-not-allowed"
                  >
